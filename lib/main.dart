...
class _MyAppState extends State<MyApp> {
  ...
  void _jawaban(int skor) {
    ...
    if (_soalIndex < pertanyaan.length) {
      print('Masih ada ${pertanyaan.length - _soalIndex} soal berikutnya.');
    } else {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Center(child: Text('Kuis Assesmen Abal-Abal')),
        ),
        body: _soalIndex < pertanyaan.length
            ...
            : Hasil(totalSkor: totalSkor, resetKuis: resetKuis),
      ),
    );
  }
}
